...
model_path = "C:/keras-retinanet/retinamodels/inference.h5"
image_path = 'C:/keras-retinanet/examples/1.jpg'
image_output_path = 'C:/keras-retinanet/examples/detected.jpg'
...
tensorflow.keras.backend.tensorflow_backend.set_session(get_session())
